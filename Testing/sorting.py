...
def selection_sort(my_list):
    ...
    print("Selection Sort Outer loop=", outer_loop)
    print("Selection Sort Inner loop=", inner_loop)
...
def insertion_sort(my_list):
    ...
    print("Insertion Sort Outer Loop =", outer_loop)
    print("Insertion Sort Inner Loop =", inner_loop)
